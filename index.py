...
def main_menu():
    while True:
        try:
            ...
            print("|___________________________________________________________________Menu_________________________________________________________________________|")
            print("|1. Có bao nhiêu đội đá trong mùa giải, liệt kê các đội?                                                                                         |")
            print("|2. Tìm số trận có kết quả hoà (FTR= Full time result: H = homewin, D = Draw, A= Awaywin)?                                                       |")
            print("|3. Tìm tổng số bàn thắng các đội đá trên sân nhà ghi được (FTHG = Full Time hometeam goal - FTAG: Full Time AwayGoal)?                          |")
            ...
            print("|8. Tạo một cột mới với tên cột tuỳ chọn: Nếu tổng số bàn thắng 2 đội ghi được trong trận  <2 thì điền “well”,                                   |")
            print("|                                         Nếu số bàn thắng  2 < x < 4 thì điền “very good”,                                                      |")
            print("|                                         Nếu số bàn thắng >= 4 thì điền “amazing”.                                                              |")
            print("|0. Thoát                                                                                                                                        |")
            print("|________________________________________________________________________________________________________________________________________________|")
